...
function ProductList() {
    ...
    const calculateTotalQuantity = () => {
        if (!Array.isArray(cartItems)) {
            console.error('Expected cartItems to be an array');
            return 0;
        }
    ...
    const handleAddToCart = (plant) => {
        ...
        dispatch(addItem({
          ...
          console.log("Item added to cart:", plant);
        // Update local state to reflect that the plant has been added to the cart
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={() => setShowCart(true)} style={styleA}><h1 className='cart'>
